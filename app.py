...
st.markdown("""
    <style>
    /* Centraliza e estiliza o título principal */
    .main-title {
        text-align: center;
        font-weight: bold;
        color: #2C3E50;
    ...
    /* Deixa os botões com aparência mais profissional */
    .stLinkButton > a {
        border-radius: 10px;
...
# Removemos o "with st.success" e usamos o divider="green" para dar a cor
...
# --- SEÇÃO 3: JURÍDICO & PROTESTO (VERMELHO) ---
